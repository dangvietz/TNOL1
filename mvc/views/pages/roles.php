    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button data-role="nhomquyen" data-action="create" type="button" class="btn btn-hero btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-role"><i class="fa-regular fa-plus me-1"></i> Thêm mới</button>
            </div>
        </div>
                    ...
                    <table class="table table-vcenter table-role">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Khoa</td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="khoa" value="view">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="khoa" value="create">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="khoa" value="update">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="khoa" value="delete">
                                </td>
                            </tr>
                            <tr>
                                <td>Ca thi</td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="cathi" value="view">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="cathi" value="create">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="cathi" value="update">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="cathi" value="delete">
                                </td>
                            </tr>
                            <!-- <tr>
                                <td>Cài đặt</td>
