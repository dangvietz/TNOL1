    ...
    <div class="row">
        ...
        <div class="col-8 d-flex align-items-center justify-content-end gap-3">
            ...
            <button type="button" class="btn btn-primary btn-sm" id="exportScores"><i class="fa-solid fa-file me-1"></i>Xuất bảng
                điểm</button>
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-add-user"><i class="fa fa-fw fa-plus me-1"></i>Thêm sinh viên</button>
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane fade fade-up show active" id="them-thu-cong" role="tabpanel" aria-labelledby="them-thu-cong-tab" tabindex="0">
                        <form id="addSvThuCong">
                            ...
                            <div class="mb-3">
                            <select class="js-select2 form-select data-nhomquyen" data-tab="1" id="user_nhomquyen" name="user_nhomquyen" style="width: 100%;" data-placeholder="Chọn nhóm cần thêm..">
                        </select>
                        </div>
                        <div class="block-content block-content-full text-end">
                        <button type="button" class="btn btn-sm btn-primary btn-group" id="addGroupId">Thêm nhóm</button>
                        </div>
                        </form>
                    ...
                    <div class="tab-pane fade fade-up" id="ma-moi" role="tabpanel" aria-labelledby="ma-moi-tab" tabindex="0">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div>
                                <button type="button" class="btn btn-alt-primary btn-sm btn-copy-code" data-bs-toggle="tooltip" data-bs-placement="top" title="Sao chép mã mời"><i class="fa fa-clipboard"></i></button>
                                <button type="button" class="btn btn-alt-primary btn-sm btn-reset-invited-code"><i class="fa fa-arrows-rotate me-1"></i>Tạo mã mới</button>
                            </div>
                        </div>
                    </div>
