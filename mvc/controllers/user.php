...
class User extends Controller
{
    ...
    public function add()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $result = $this->NguoiDungModel->create($id, $email, $hoten, $password, $ngaysinh, $gioitinh, $nhomquyen, $trangthai, $lop);
            echo $result;
        }
    }
    ...
    public function update()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $lop = $_POST['lop'];
            $trangthai = $_POST['status'];
            $result = $this->NguoiDungModel->update($id, $email, $hoten, $password, $ngaysinh, $gioitinh, $nhomquyen, $trangthai, $lop);
            echo $result;
        }
    }
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            for ($i = 3; $i <= $Totalrow; $i++) {
                ...
                for ($j = 0; $j < $TotalCol; $j++) {
                    ...
                    if ($j == 4) $lop = $sheet->getCellByColumnAndRow($j, $i)->getValue();
                }
