...
//Vị trí có dạng như sau:
    ...
    public function getAllGroup(){
        $manhom = $_POST['manhom'];
        $result = $this->nhomModel->getAllGroup($manhom);
        echo json_encode($result);
    }

    public function addUserAllGroup(){
        $nhomhientai = $_POST['nhomhientai'];
        $manhom = $_POST['manhom'];
        $result = $this->nhomModel->addUserAllGroup($nhomhientai,$manhom);
        echo $result;
    }
